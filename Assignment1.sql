...
-- PRIMARY KEYS : actor_id, address_id, advisor_id, category_id, city_id, country_id, customer_id,
--                film_id, inventory_id, investor_id, language_id, payment_id, rental_id, staff_id,
--                store_id
-- FOREIGN KEYS : original_language_id, manager_staff_id, city_id, country_id, address_id, store_id,
--                language_id, actor_id, film_id, category_id, rental_id, customer_id, staff_id, 
--                inventory_id, 
-- The difference is  unique key gives the unique values in a table, where as foreign key establishes
...
select count(distinct first_name) as Number_of_Names from actor;
